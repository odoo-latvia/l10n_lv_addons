...
class ResPartner(models.Model):
    ...
    def onchange_load_from_registry(self):
        ...
        if registry:
            ...
            if c_reg_num:
                val['partner_registry'] = c_reg_num[0].toxml().replace('<regnum>','').replace('</regnum>','')
