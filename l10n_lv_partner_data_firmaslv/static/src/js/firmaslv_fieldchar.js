odoo.define('l10n_lv_partner_data_firmaslv.fieldchar', function (require) {
'use strict';

var basic_fields = require('web.basic_fields');
var core = require('web.core');
var field_registry = require('web.field_registry');
var FirmasLVMixin = require('l10n_lv_partner_data_firmaslv.Mixin');
 ...
 */
var FieldFirmasLV = FieldChar.extend(FirmasLVMixin, {
    className: 'o_firmaslv',
    debounceSuggestions: 400,
    resetOnAnyFieldChange: true,
    xmlDependencies: ['/l10n_lv_partner_data_firmaslv/static/src/xml/firmaslv.xml'],

    events: _.extend({}, FieldChar.prototype.events, {
        'keyup': '_onKeyup',
        'mousedown .o_firmaslv_suggestion': '_onMousedown',
        'focusout': '_onFocusout',
        'mouseenter .o_firmaslv_suggestion': '_onHoverDropdown',
        'click .o_firmaslv_suggestion': '_onSuggestionClicked',
    }),
    ...
    init: function () {
        ...
        // If the firmas.lv is applied to vat field, only search valid vat number
    ...
    /**
     * Check if the firmas.lv should be active
     * Active :
    ...
    _showDropdown: function () {
        ...
        if (this.suggestions.length > 0) {
            this.$dropdown = $(QWeb.render('l10n_lv_partner_data_firmaslv.dropdown', {
    ...
    _suggestCompanies: function (value) {
        ...
        if (this._validateSearchTerm(value, this.onlyVAT) && this._isOnline()) {
            return this._firmaslv(value).then(function (suggestions) {
    ...
    _onKeyup: function (e) {
        switch (e.which) {
            ...
            case $.ui.keyCode.ENTER:
                ...
                e.preventDefault();
                var $active = this.$dropdown.find('.o_firmaslv_suggestion.active');
                if (!$active.length) {
                    return;
                }
...
field_registry.add('firmaslv', FieldFirmasLV);

return FieldFirmasLV;
});
