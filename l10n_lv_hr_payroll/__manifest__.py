...
Latvian Payroll
-------------------------
Adds Tax Relief table in Employee form.
...
Adds button "Reload Inputs" in Payslip form, which calls the Employee onchange function, so that, in case of data change, you don't have to edit the payslip and change employee again to see it.
    """,
    'author': 'Allegro IT',
